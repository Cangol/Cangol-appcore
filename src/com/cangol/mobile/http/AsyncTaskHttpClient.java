 ...
 * <p>
 * <pre>
 * AsyncTaskHttpClient client = new AsyncTaskHttpClient();
...
public class AsyncTaskHttpClient {
   ...
   /**
    ...
    public void cancelRequests(Context context, boolean mayInterruptIfRunning) {
        ...
        if(requestList != null) {
            for(WeakReference<AsyncTaskHttpRequest> requestRef : requestList) {
    ...
    protected void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, AsyncHttpResponseHandler responseHandler, Context context) {
        ...
        if(context != null) {
            ...
            List<WeakReference<AsyncTaskHttpRequest>> requestList = requestMap.get(context);
            if(requestList == null) {
                requestList = new LinkedList<WeakReference<AsyncTaskHttpRequest>>();
                requestMap.put(context, requestList);
            }

            requestList.add(new WeakReference<AsyncTaskHttpRequest>(request));
