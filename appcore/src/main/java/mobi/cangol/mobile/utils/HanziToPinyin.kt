...
open class HanziToPinyin protected constructor(private val mHasChinaCollator: Boolean) {
     ...
     */
    operator fun get(input: String): List<Token> {
    ...
    private fun addToken(sb: StringBuilder, tokens: MutableList<Token>, tokenType: Int) {
        val str = sb.toString()
